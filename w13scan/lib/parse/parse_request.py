...
from w13scan.lib.core.common import paramToDict
from w13scan.lib.core.enums import PLACE, POST_HINT, HTTPMETHOD
from w13scan.lib.core.settings import DEFAULT_GET_POST_DELIMITER, JSON_RECOGNITION_REGEX, XML_RECOGNITION_REGEX, \
